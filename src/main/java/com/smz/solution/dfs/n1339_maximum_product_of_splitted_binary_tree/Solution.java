...
public class Solution {
    ...
    public static void main(String[] args) throws NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        testTrees.add(new IntegerValueBinaryTree(new Integer[]{1,2,3,4,5,6}));
        testTrees.add(new IntegerValueBinaryTree(new Integer[]{1,null,2,null,null,3,4,null,null,null,null,null,null,5,6}));
